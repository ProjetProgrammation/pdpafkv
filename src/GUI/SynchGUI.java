...
public class SynchGUI {
    ...
    public void synchAudioVideo() {
        ...
        String filenameaudio = "Audio\\seth.mp3"; //this is the input file for audio. you can change extension

        IMediaWriter mWriter = ToolFactory.makeWriter("output.flv"); //output file
